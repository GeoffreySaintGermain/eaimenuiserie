...
@MessageDriven(mappedName = "affaireModifiee", activationConfig = {
    @ActivationConfigProperty(propertyName = "clientId", propertyValue = "scaaffaireModifieePOSEE")
    ,
    ...
    ,
        @ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "JMSType = 'POSEE'")
})
public class GetAffaireModifieePOSEE implements MessageListener {

    @EJB
    private AffairesLocal affaires;
    
    public GetAffaireModifieePOSEE() {
    }
    ...
    public void onMessage(Message message) {
        if (message instanceof TextMessage) {
            ...
            try {
                affaires.modifierStatut(obj.getText(), Affaire.statutAffaire.POSEE);
